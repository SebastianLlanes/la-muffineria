      ...
      <div className={styles.container}>
        ...
        <div className={styles.brand}>
          <a href="#inicio" className={styles.logo}>
            <span className={styles.logoIcon} aria-hidden="true">
              <img src={IconMuffin} alt="Muffin Icon" />
              </span>
        ...
        <div className={styles.contact}>
          ...
          <ul className={styles.contactList}>
            <li>
              <a
                href="https://wa.me/5493482608105"
                target="_blank"
                rel="noopener noreferrer"
                className={`${styles.navLink} ${styles.whatsappLink}`}
              >
                <WhatsAppMiniIcon />
                WhatsApp
              </a>
      ...
      <div className={styles.bottom}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            © {CURRENT_YEAR} La Muffinería · Hecho con 💛 en San Carlos Centro
          </p>
          <p className={styles.credit}>
            Desarrollado por{' '}
            <a
              href="https://sebastian-llanes.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
